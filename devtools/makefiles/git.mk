...
# .PHONY: push-upstream
# push-upstream: ## Git push current branch to remote with `--set-upstream`
...
.PHONY: push-force
push-force:  ## Git force push with `--force-with-lease`
...
.PHONY: pull-force
pull-force: ## Fetch to the latest then use remote to override local branch
	$(eval cb := $(shell $(GIT) rev-parse --abbrev-ref HEAD))
